...
class Helper_Captcha {
    ...
    private function createImg() {
        ...
        $bgColor = imagecolorallocate($this->im, rand(150,200), rand(150,200), rand(150,200));
    ...
    private function setCaptcha() {
        ...
        for ($i = 0; $i < $this->codeNum; $i++) {
            $color = imagecolorallocate($this->im, rand(1, 50), rand(1, 50), rand(1, 100));
